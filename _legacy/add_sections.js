...
servicesList.forEach(s => {
    servicesHtml += `
            <div class="bg-surface p-4 rounded-xl shadow-sm border border-surface-container-high hover:border-primary-container/50 transition-colors flex items-start gap-3 group">
...
function buildAddressList(list) {
    return list.map(a => `
...
const aboutHtml = `
<!-- About Us Section -->
<section class="py-24 bg-surface border-b border-surface-container-high">
...
<section class="py-24 bg-surface-container-low border-b border-surface-container-high relative overflow-hidden">
    <div class="absolute -top-40 -right-40 w-96 h-96 bg-primary-container/5 rounded-full blur-3xl"></div>
...
<!-- 3 Steps Process -->
<section class="py-24 bg-background border-b border-surface-container-high">
    <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
        <div class="text-center mb-16">
...
<section class="py-16 px-margin-mobile md:px-margin-desktop bg-surface">
    <div class="max-w-max-width mx-auto bg-gradient-to-r from-primary-container to-secondary-container rounded-3xl p-8 md:p-16 shadow-2xl relative overflow-hidden">
        ...
        <div class="absolute bottom-0 left-0 w-64 h-64 bg-black/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4"></div>
        
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div class="text-center md:text-left">
                <h2 class="text-display-lg font-display-lg text-on-primary-container mb-4 text-3xl md:text-5xl">Nhận Báo Giá Ưu Đãi!</h2>
...
<!-- Branches Section -->
<section class="py-24 bg-surface border-t border-surface-container-high">
    <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
        <div class="text-center mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-surface-container-low p-6 rounded-2xl border border-surface-container-high shadow-sm hover:shadow-md transition-shadow">
                ...
                <ul class="space-y-4 max-h-96 overflow-y-auto pr-2 custom-scrollbar">
${buildAddressList(binhDuongAddresses)}
                </ul>
            </div>
            ...
            <div class="bg-surface-container-low p-6 rounded-2xl border border-surface-container-high shadow-sm hover:shadow-md transition-shadow">
                ...
                <ul class="space-y-4 max-h-96 overflow-y-auto pr-2 custom-scrollbar">
${buildAddressList(dongNaiAddresses)}
                </ul>
            </div>
...
if (!html.includes('Về Chúng Tôi')) {
    html = html.replace('<!-- Primary Services Grid -->', aboutHtml + '\n    <!-- Primary Services Grid -->');
    html = html.replace('<!-- Footer -->', extraSectionsHtml + '\n    <!-- Footer -->');
