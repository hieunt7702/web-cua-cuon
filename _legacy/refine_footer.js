        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-headline-md font-headline-md font-bold text-on-surface uppercase tracking-wide">
                        Cửa Cuốn Việt Đức
                    </span>
                </div>
                ...
                <div class="space-y-3 pt-4 border-t border-surface-container-high">
                    <div class="flex items-center gap-3 text-on-surface-variant group">
                        <div class="w-10 h-10 rounded-full bg-surface-container flex items-center justify-center group-hover:bg-primary-container transition-colors shadow-sm">
                            <span class="material-symbols-outlined text-primary-container group-hover:text-on-primary-container text-lg" style="font-variation-settings: 'FILL' 1;">call</span>
                        </div>
                        <div>
                            <div class="text-label-sm uppercase tracking-widest opacity-70">Hotline 24/7</div>
                            <a href="tel:0982674327" class="text-body-lg font-medium text-primary-container hover:text-primary transition-colors">098.267.4327</a>
                        </div>
                    </div>
                    <div class="flex items-center gap-3 text-on-surface-variant group">
                        <div class="w-10 h-10 rounded-full bg-surface-container flex items-center justify-center group-hover:bg-primary-container transition-colors shadow-sm">
                            <span class="material-symbols-outlined text-primary-container group-hover:text-on-primary-container text-lg" style="font-variation-settings: 'FILL' 1;">mail</span>
                        </div>
                        <div>
                            <div class="text-label-sm uppercase tracking-widest opacity-70">Email Doanh Nghiệp</div>
                            <a href="mailto:cuacuonvietduc0421@gmail.com" class="text-body-md text-on-surface hover:text-primary-container transition-colors break-all">cuacuonvietduc0421@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <h3 class="text-headline-sm font-headline-sm text-on-surface mb-6 relative inline-block">
                    Dịch Vụ Nổi Bật
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    <span class="px-3 py-1 bg-surface-container border border-surface-container-high rounded-full text-label-sm text-on-surface hover:border-primary-container transition-colors cursor-default">TP. Hồ Chí Minh</span>
                    <span class="px-3 py-1 bg-surface-container border border-surface-container-high rounded-full text-label-sm text-on-surface hover:border-primary-container transition-colors cursor-default">Bình Dương</span>
                    <span class="px-3 py-1 bg-surface-container border border-surface-container-high rounded-full text-label-sm text-on-surface hover:border-primary-container transition-colors cursor-default">Đồng Nai</span>
                    <span class="px-3 py-1 bg-surface-container border border-surface-container-high rounded-full text-label-sm text-on-surface hover:border-primary-container transition-colors cursor-default">Long An</span>
                </div>
            </div>
