          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <article className="lg:col-span-8">
              ...
              <div className="mb-8">
                ...
                <h1 className="text-headline-lg md:text-display-sm font-display-lg text-on-surface mb-6 uppercase leading-tight">
                  {post.title}
                </h1>
              ...
              {/* Markdown Content */}
              <div className="prose prose-lg dark:prose-invert prose-headings:font-display-lg prose-headings:uppercase prose-a:text-primary-container hover:prose-a:text-primary max-w-none prose-img:rounded-xl">
